...
public class RayTracerBenchMark extends BenchMark {
	...
	public void prepare() {
		...
		try {
			...
			// Scene
			fields.add(new jmplib.reflect.Field(Modifier.PUBLIC, ArrayList.class, "lights", "new ArrayList()"));
			fields.add(new jmplib.reflect.Field(Modifier.PUBLIC, ArrayList.class, "objects", "new ArrayList()"));
