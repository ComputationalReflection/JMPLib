...
public class RatePath extends PathId {
     ...
     * @throws DemoException thrown if there is a problem reading in
     *                       the data file.
     */
     ...
     *           be copied over.
     * @throws DemoException thrown if there is an attempt to access
    ...
    public void initMc(MonteCarloPath mc) throws DemoException {
        //
        // Fields pertaining to the parent PathId object:
        set_name(mc.get_name());
        set_startDate(mc.get_startDate());
     ...
     * @throws DemoException thrown if there is a mismatch between the
     ...
     * @throws DemoException thrown if instance variable <code>pathDate</code> is undefined.
     */
     ...
     * @throws DemoException thrown if there is a problem with the
     *                       calculation.
     */
...
//        return (rPath);
     ...
     * @throws DemoException thrown if there was a problem with the data
     *                       file.
     */
    public void readRatesFile(String dirName, String filename) throws DemoException {
