...
//    private int runMode;
    ...
    public AppDemo(
            ...
            int nRunsMC) {
        init(dataDirname, dataFilename, nTimeStepsMC, nRunsMC);
    }

    public void init(String dataDirname, String dataFilename, int nTimeStepsMC,
                     int nRunsMC) {
...
//            RatePath rateP = new RatePath(this.dataDirname, this.dataFilename);
//            rateP.dbgDumpFields();
...
//        }
     ...
     *
     * @throws DemoException thrown if there is a problem with reading in
     *                       any values.
     */
