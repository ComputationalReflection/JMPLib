...
public class MonteCarloPath extends PathId {
     ...
     *                   random path.
     * @throws DemoException Thrown if there is a problem initialising the
     ...
     * @throws DemoException thrown if instance variable <code>fluctuations</code>
     *                       is undefined.
     */
     ...
     * @throws DemoException thrown if instance variable <code>pathValue</code>
     *                       is undefined.
     */
     ...
     * @throws DemoException thrown if instance variable <code>returnDefinition</code>
     *                       is undefined.
     */
     ...
     * @throws DemoException thrown if instance variable <code>expectedReturnRate</code>
     *                       is undefined.
     */
     ...
     * @throws DemoException thrown if instance variable <code>volatility</code>
     *                       is undefined.
     */
     ...
     * @throws DemoException thrown if instance variable <code>nTimeSteps</code>
     *                       is undefined.
     */
     ...
     * @throws DemoException thrown if instance variable <code>pathStartValue</code>
     *                       is undefined.
     */
     ...
     * data.
     * @throws DemoException thrown if there was a problem creating
     *                       the RatePath object.
     */
     ...
     * @throws DemoException thrown if there are any problems with
     *                       the computation.
     */
