...
package es.uniovi.jmplib.testing.javagrande.montecarlo;
...
public class ReturnPath extends PathId {
     ...
     * @throws DemoException thrown if instance variable <code>pathValue</code> is undefined.
     */
     ...
     * @throws DemoException thrown if instance variable <code>nPathValue</code> is undefined.
     */
     ...
     * @throws DemoException thrown if instance variable <code>returnDefinition</code> is undefined.
     */
     ...
     * @throws DemoException thrown if instance variable <code>expectedReturnRate</code> is undefined.
     */
     ...
     * @throws DemoException thrown if instance variable <code>volatility</code> is undefined.
     */
     ...
     * @throws DemoException thrown if instance variable <code>volatility2</code> is undefined.
     */
     ...
     * @throws DemoException thrown if instance variable <code>mean</code> is undefined.
     */
     ...
     * @throws DemoException thrown if instance variable <code>variance</code> is undefined.
     */
     ...
     *
     * @throws DemoException thrown one tries to obtain an undefined variable.
     */
     ...
     * \sigma^2 = s^2\Delta t
     *
     * @throws DemoException thrown if one of the quantites in the
     ...
     * calculations.
     *
     * @throws DemoException thrown if <code>nPathValue</code> is
     *                       undefined.
     */
     ...
     * calculations.
     *
     * @throws DemoException thrown if the <code>mean</code> or
     ...
     *
     * @throws DemoException thrown if there is a problem reading any
     *                       variables.
     */
