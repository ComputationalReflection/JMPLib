...
public class IntercessorUtils {
     ...
     * @throws CompilationFailedException      If the class have compilation errors
     * @throws StructuralIntercessionException If some errors ocurrs
     * @throws RuntimeException                If there are errors accesing the files, obtaining the class or
     ...
     * @param methodInterface        The functional interface
     * @param modifiers              The modifiers of the method
     * @param parametrizationClasses The classes that parametrize the interface
     * @throws NoSuchMethodException If no method matches the functional interface method in the last
     ...
     * @throws NoSuchFieldException If the field isn't public or doesn't exist
     */
