...
//            + "}";
     ...
     * class
     */
    public static final String THREAD_SAFE_CREATOR_TEMPLATE = String.join("\n", "{"
...
//            + "}";
     ...
     * of a cached class
     */
    public static final String INVOKER_BODY_TEMPLATE = String.join("\n", "{"
...
//            + "}";
     ...
     * of a cached class
     */
//    public static final String THREAD_SAFE_INVOKER_BODY_TEMPLATE = String.join("\n", "{"
...
//            + "}";
     ...
     */
    public static final String FIELD_GETTER_TEMPLATE = String.join("\n", "{"
...
//            + "}";
     ...
     * field of a cached class
     */
//    public static final String THREAD_SAFE_FIELD_GETTER_TEMPLATE = String.join("\n", "{"
//            , "synchronized(jmplib.primitives.ThreadSafePrimitiveExecutor.class) {"
//            , " o." + Templates.JMPLIB_MONITOR_NAME + ".readLock().lock();"
//            , " if(o.get_CurrentInstanceVersion() != %3$s._currentClassVersion) {"
//            , "   try {"
...
//            + "}";
     ...
     * field of a cached class
     */
    public static final String FIELD_SETTER_TEMPLATE = String.join("\n", "{"
            , "if(o.get_CurrentInstanceVersion() != %3$s._currentClassVersion)"
            , " _creator(o);"
...
//            + "}";
     ...
     * field of a cached class
     */
//    public static final String THREAD_SAFE_FIELD_SETTER_TEMPLATE = String.join("\n", "{"
//            , "synchronized(jmplib.primitives.ThreadSafePrimitiveExecutor.class) {"
//            , " o." + Templates.JMPLIB_MONITOR_NAME + ".readLock().lock();"
//            , "if(o.get_CurrentInstanceVersion() != %3$s._currentClassVersion) {"
//            , "  try {"
...
//            + "}";
    ...
    // %2$s: NewClass
    // %3$s: OriginalClass
    public static final String INSTANCE_FIELD_UNARY_TEMPLATE = String.join("\n", "{"
            , "if(o.get_CurrentInstanceVersion() != %3$s._currentClassVersion)"
            , " _creator(o);"
            , "switch (type) {"
            , " case 1:"
...
//            + "}";
    ...
    public static final String THREAD_SAFE_INSTANCE_FIELD_UNARY_TEMPLATE = String.join("\n", "{"
            , "synchronized(jmplib.primitives.ThreadSafePrimitiveExecutor.class) {"
            , " o." + Templates.JMPLIB_MONITOR_NAME + ".readLock().lock();"
            , "if(o.get_CurrentInstanceVersion() != %3$s._currentClassVersion) {"
            , "  Class<?> cl = jmplib.classversions.VersionTables.getNewVersion(%3$s.class);"
...
//            + "}";
    ...
    // %1$s: FieldName
    // %2$s: Class
    public static final String STATIC_FIELD_UNARY_TEMPLATE = String.join("\n", "{"
