...
public class MemberFinder {
     ...
     *
     * @param interfaceClass Functional interface
     ...
     *
     * @param declaring The class owner
     * @param name      The name of the method
     * @return The method data
     * @throws StructuralIntercessionException There are more than one method
     ...
     *
     * @param m                      Generic method
     * @param parametrizationClasses Parametrization classes
