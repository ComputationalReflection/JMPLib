...
public class ExternalFieldAccessTransformer extends AbstractTransformer
     ...
     * annotation list
     *
     * @param visibleAnnotations Annotation list
     ...
     *
     * @param methodNode The method node where the access is
     * @param fieldNode  The access node
     ...
     *
     * @param methodNode The method node where the assign is
     * @param fieldNode  The assign node
     * @param index      The index of the instruction
     */
