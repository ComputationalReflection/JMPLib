...
public class ASMUtils {
	 ...
	 * 
	 * @param is
	 *            The {@link InputStream} to read the bytes of the class to ASMified
	 * @return The code to generate the class
	 */
	 ...
	 * 
	 * @param clazz
	 *            The {@link InputStream} to read the bytes of the class to obtain
	 *            the bytecode
	 * @return The bytecode of the class
	 */
	...
	public static VarInsnNode getParamInsn(Type type, int number) {
		VarInsnNode varNode = new VarInsnNode(getVarOpcode(type.getDescriptor()), number);
		return varNode;
	}
