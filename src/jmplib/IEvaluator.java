...
public interface IEvaluator {
     ...
     * @param info  The invoker data needed to obtain the invoker of the specified
     *              method
     * @return The populated interface with the invoker
     * @throws StructuralIntercessionException If a problem was encountered before finishing
     */
    <T> T getMethodInvoker(Type clazz, String name, MemberInvokerData<T> info) throws StructuralIntercessionException;
     ...
     * @throws StructuralIntercessionException If a problem was encountered before finishing
     */
    <T> T getFieldInvoker(Type clazz, String name, MemberInvokerData<T> info) throws StructuralIntercessionException;
     ...
     * @throws StructuralIntercessionException If a problem was encountered before finishing
     */
    <T> T setFieldInvoker(Type clazz, String name, MemberInvokerData<T> info) throws StructuralIntercessionException;
     ...
     *
     * @param packageName Package name of the class to be created
     * @param className   Name of the class to be created
     * @param imports     Import clauses to be included in the new file.
     * @return A class with the specified name and imports but with no contents
     */
    Class<?> createEmptyClass(String packageName, String className, AnnotatedElement... imports)
     ...
     * </p>
     *
     * @param classSource source code of the class
     ...
     */
    Class<?> exec(String classSource) throws StructuralIntercessionException;
     ...
     * </p>
     *
     * @param code        the code to enclose in the interface method
     * @param invokerData Data needed to perform the code evaluation
     * @throws StructuralIntercessionException If problems with the metaprogramming primitives are detected (exception
     *                                         *                                         message indicates the concrete problem, as it wraps the inner exception)
     */
    <T> T generateEvalInvoker(String code, EvalInvokerData<T> invokerData)
            throws StructuralIntercessionException;
}
