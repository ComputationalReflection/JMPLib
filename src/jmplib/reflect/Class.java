...
public class Class<T> implements java.io.Serializable, GenericDeclaration, Type, AnnotatedElement {
	...
	/**
	 * Pretty-prints a method source body, indenting it a certain amount of tabs and removing empty lines
	 * @param source Code
	...
	public String getSourceCode() throws StructuralIntercessionException {
		...
		AnnotatedElement[] importClasses = DefaultIntercessor.getInstance().getImports(this.getDecoratedClass());
