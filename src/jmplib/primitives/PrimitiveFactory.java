...
public class PrimitiveFactory {
     ...
     * @param init      The initialization sequence of the field
     * @return The {@link Primitive} ready to be executed
     * @throws StructuralIntercessionException
     */
     ...
     * @param newInit The new initialization sequence
     * @return The {@link Primitive} ready to be executed
     * @throws StructuralIntercessionException
     */
     ...
     *
     * @param clazz          Class to add interface to
     * @param interf         Interface to add to the class
     * @param typeParameters Type of the generic parameters of the interface to add (optional)
     * @return The {@link Primitive} ready to be executed
     * @throws StructuralIntercessionException
     */
